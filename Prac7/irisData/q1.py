...
for unit in testData:
    ...
    print ""
    print "Test Item " + str(p+1)
    print "Actual Class: "
    print define_flower(testLabels[p][0])
    print "Classified: "
    print most_type(nearest_neighbours(k,unit,trainData,trainLabels))

    if (define_flower(testLabels[p][0]))!=most_type(nearest_neighbours(k,unit,trainData,trainLabels)):
        errors +=1
